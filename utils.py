...
def to_glove_dataset(sentences: List[List[int]], vocab_size: int, window_size: int = 5) -> Tuple[np.ndarray, np.ndarray, np.ndarray, sparse.lil_matrix]:
    ...
    return np.array(central), np.array(context), np.array(y), matrix
